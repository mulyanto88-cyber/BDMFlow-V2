...
export default function Sidebar() {
  ...
  return (
    <>
      {/* ── DESKTOP SIDEBAR ── */}
      <aside
        className={`hidden md:flex flex-col border-r ${mounted ? 'transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]' : ''} ${collapsed ? 'w-[60px]' : 'w-[228px]'} h-screen sticky top-0 shrink-0`}
