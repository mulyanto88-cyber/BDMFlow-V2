...
export default function BandarmologiPage() {
  ...
  const primeColumns = [
    ...
    primeCol.accessor('tier_pct', { header: 'Signal', cell: r => <TierBadge tier={String(r.getValue() ?? '')} /> }),
  ...
  const convColumns = [
    ...
    convCol.accessor('tier_pct', { header: 'Signal', cell: r => <TierBadge tier={String(r.getValue() ?? '')} /> }),
  ...
  const leaderColumns = [
    ...
    leaderCol.accessor('tier_pct', { header: 'Signal', cell: r => <TierBadge tier={String(r.getValue() ?? '')} /> }),
